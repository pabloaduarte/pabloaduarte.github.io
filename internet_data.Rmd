...
```{r echo=FALSE, message= FALSE, warning=FALSE}
##China Data
ctrip <- data.frame(read.csv("C:/Users/DuarteP/Documents/projects/china_nowcast/ctrip.csv", sep=","))
ctrip <- ctrip[,2:3]
colnames(ctrip)<-c("time", "Ctrip")
ctrip_cn <- ts_xts(ctrip)

flight_ticket <- data.frame(read.csv("C:/Users/DuarteP/Documents/projects/china_nowcast/flight ticket.csv", sep = ","))[,2:3]
colnames(flight_ticket) <- c("time", "Flight Ticket")
flight_ticket_cn <- ts_xts(flight_ticket)

reservation <- data.frame(read.csv("C:/Users/DuarteP/Documents/projects/china_nowcast/reservation.csv", sep=","))[,2:3]
colnames(reservation)<-c("time", "Reservation")
reservation_cn <- ts_xts(reservation)

restaurant <- data.frame(read.csv("C:/Users/DuarteP/Documents/projects/china_nowcast/restaurant.csv", sep=","))[,2:3]
colnames(restaurant)<-c("time", "Restaurant")
restaurant_cn <- ts_xts(restaurant)

hotel <- data.frame(read.csv("C:/Users/DuarteP/Documents/projects/china_nowcast/hotel.csv", sep=","))[,2:3]
...
p_hotels <- highchart(type = "stock" ) %>% 
 ...
 hc_subtitle(text = "Quelle: Flossbach von Storch Research Institute, Google Trends.") %>% 
  ...
  hc_add_series(hotels["201612/"]$FR, name = "Frankreich", connectNulls = TRUE ) %>% 
