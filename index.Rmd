...
dygraph(google_week["202003/"], main = "Google Community Mobility Reports: Arbeitsplätze", width = 800)%>%
dyAxis("x", drawGrid = FALSE)%>% 
dyHighlight(highlightSeriesOpts = list(strokeWidth = 2))%>%
...
dygraph(google_stationeek["202003/"], main = "Google Mobility Reports: Bahnhöfe und Haltestellen", width = 800)%>%
dyAxis("x", drawGrid = FALSE)%>% 
dyHighlight(highlightSeriesOpts = list(strokeWidth = 2))%>%
dyOptions(colors = c("black","maroon", "gray", "red", "blue", "orange", "green", "navy"))%>%
dyCSS("legend.css")%>%
