...
#library(gridExtra)
```
#### Die **Industrieproduktion** in **China** wuchs im April 3.9% (YoY) und in den **USA** sank sie um 11.25%. Den schwersten Einbruch erlitt im März **Italien** mit -28% (YoY). In der **Eurozone** ging die Industriproduktion um 11.25% zurück.  
