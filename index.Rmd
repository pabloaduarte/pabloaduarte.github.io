...
*We estimate an approximate dynamic factor model such that $y^i_t = f_t + v^i_t$, where $y^i_t$ is a vector with all series of indicators, including GDP, $f_t$ a common factor, which is the activity index, and a idiosyncratic error term $v^i-t$ unique for each series.*
